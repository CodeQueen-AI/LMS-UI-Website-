...
//   // Icon floating animation config
...
//         <motion.div
//           className="absolute top-10 left-10 text-pink-500"
...
//           animate={{ ...floatAnimation, transition: { duration: 3.5, repeat: Infinity } }}
//         >
//           <FileText size={40} />
//         </motion.div>
...
//           <h1 className="text-7xl font-serif font-medium text-blue-900 mb-4">
//             About Us
//           </h1>
//         </div>
//       </section>
...
//       {/* ==================== TEXT + IMAGE SECTION ==================== */}
//       <section className="max-w-6xl mx-auto py-20 px-8 grid md:grid-cols-2 gap-12 items-center">
//         {/* Left Content */}
//         {/* Left Content */}
// <div>
//   <h2 className="text-5xl font-semibold font-serif text-blue-900 mb-6">
//     Who We Are
//   </h2>
//   <p className="leading-relaxed mb-6">
//     At <span className="font-semibold text-blue-900">Ductauon</span>, we believe education is more than just learning — it’s transformation. 
//     Our mission is to bridge the gap between curiosity and clarity, connecting learners with expert tutors who ignite understanding, 
//     confidence, and lifelong growth
//   </p>
//   <p className="leading-relaxed mb-6">
//     We’re redefining what it means to learn in the digital age — bringing together technology, personalized guidance, 
//     and human connection to make knowledge truly accessible for everyone.
//   </p>
...
//       <span>
//         <span className="font-semibold text-gray-900 font-serif">Global Learning Community —</span> 
//         We unite students and educators from every corner of the world, building a vibrant space where knowledge knows no borders.
//       </span>
//     </li>
//     <li className="flex items-start gap-3">
//       <span className="text-blue-700 font-serif">2.</span>
//       <span>
//         <span className="font-semibold text-gray-900 font-serif">Personalized Mentorship —</span> 
//         Our tutors don’t just teach — they mentor, inspire, and adapt to every learner’s unique goals and pace.
//       </span>
//     </li>
//     <li className="flex items-start gap-3">
//       <span className="text-blue-700 font-serif">3.</span>
//       <span>
//         <span className="font-semibold text-gray-900 font-serif">Accessible Excellence —</span> 
//         With innovative tools and flexible learning models, we make high-quality education available to all, anytime, anywhere.
//       </span>
//     </li>
//   </ul>
// </div>
...
//             <Image
//               src="/About.jpg" // 👈 apni image ka path daalna (public folder me)
//               alt="About Ductauon"
//               width={500}
//               height={400}
    ...
    <div className={`bg-white ${poppins.className}`}>
      ...
      >
        ...
        <div>
          ...
          <h3 className="text-2xl font-medium font-serif text-blue-900 mb-4">
            What Defines Us
          </h3>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3">
